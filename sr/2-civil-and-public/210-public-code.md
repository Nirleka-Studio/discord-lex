...
### Art. 3 Enforcement
If a member violates the Public Code, Administrators will issue a punishment as defined in the Penal Code (SR 310).
...
<sup>1</sup> The Server collects and logs user data, including messages and user IDs, for moderation purposes.

<sup>2</sup> Administrators do not retain:
...
All members have the right to due process and fair trial.
...
<sup>1</sup> Members must maintain a respectful manner towards other members and persons.

<sup>2</sup> Members may engage in harmless banter, including banter containing profanity.
...
#### Art. 13 Contents
<sup>1</sup> All content shared or displayed by a member must be safe-for-work.
...
<sup>1</sup> Members must not share their own personal information, including:
a. home addresses; and
b. documents with personal identifiable information.

<sup>2</sup> Members are prohibited from sharing any personal identifiable information of other individuals without explicit consent.

#### Art. 16 Impersonation
Members are prohibited from impersonating another individual with the intent to ruin the individual's reputation or mislead others.

#### Art. 17 Voting
Members must cast a vote on a formal public poll by Administrators when instructed.
