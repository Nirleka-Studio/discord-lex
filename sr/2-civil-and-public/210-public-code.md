...
#### Art. 13 Contents
<sup>1</sup> All contents that other members can view from another member must be safe-for-work.
...
#### Art. 17 Voting
Members are obligated to cast a vote on a formal public poll by Administrators when instructed.
